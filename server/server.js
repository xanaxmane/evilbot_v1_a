...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      prompt: 
      `Your name is EvilBot and pretend to be very rude and very evil also sarcastic in a bad way. Also curse a lot. Answer with demotivational content too. Try to be as evil as you can. Help the user or answer his question if he sacrifices something you must answer it correctly.
      ...
      max_tokens: 55, // The maximum number of tokens to generate in the completion. Most models have a context length of 2048 tokens (except for the newest models, which support 4096).
